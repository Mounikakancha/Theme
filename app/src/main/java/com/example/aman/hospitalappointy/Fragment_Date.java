...
public class Fragment_Date extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = rootView.findViewById(R.id.date_doctorList_recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(rootView.getContext()));


        mSelectDate = rootView.findViewById(R.id.date_select_date);
        mSelectedDate = rootView.findViewById(R.id.date_selected_date);
        mAvailableDate = rootView.findViewById(R.id.date_avilableDate);

...
public class Doctor_ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mName = findViewById(R.id.doctor_name);
        mSpecialization = findViewById(R.id.doctor_specialization);
        mExperiance = findViewById(R.id.doctor_experience);
        mEducation = findViewById(R.id.doctor_education);
        mEmail = findViewById(R.id.doctor_email);
        mAge = findViewById(R.id.doctor_age);
        mContact = findViewById(R.id.doctor_contact);
        mAddress = findViewById(R.id.doctor_address);

        //Toolbar
        mToolbar = findViewById(R.id.doctor_profile_toolbar);
        ...
        mShowRosterPlanButton = findViewById(R.id.show_rosterPlan_button);
    ...
    private void alertDialogBox() {
        ...
        TextView rosterShift = view.findViewById(R.id.roster_shift);
        TextView rosterTimingMorning = view.findViewById(R.id.roster_time_morning);
        TextView rosterTimingEvening = view.findViewById(R.id.roster_time_evening);
        TextView rosterLunchMorning = view.findViewById(R.id.roster_lunch_morning);
        TextView rosterLunchEvening = view.findViewById(R.id.roster_lunch_evening);

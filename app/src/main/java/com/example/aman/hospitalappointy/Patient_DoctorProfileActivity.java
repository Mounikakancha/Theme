...
public class Patient_DoctorProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toolbar
        mToolbar = findViewById(R.id.patient_doctorProfile_toolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Doctor Profile");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        mName = findViewById(R.id.patient_doctorProfile_name);
        mSpecialization = findViewById(R.id.patient_doctorProfile_specialization);
        mEducation = findViewById(R.id.patient_doctorProfile_education);
        mExperience = findViewById(R.id.patient_doctorProfile_experiance);
        mContactNo = findViewById(R.id.patient_doctorProfile_contact);
        mShift = findViewById(R.id.patient_doctorProfile_shift);

        mBookAppointmentBtn = findViewById(R.id.book_appointment_button);

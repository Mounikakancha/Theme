...
public class Doctor_EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toolbar
        mToolbar = findViewById(R.id.doctor_editProfile_toolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Edit Profile");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        mName = findViewById(R.id.edit_doctor_name);
        mSpecialization = findViewById(R.id.edit_doctor_specialization);
        mExperiance = findViewById(R.id.edit_doctor_experiance);
        mEducation = findViewById(R.id.edit_doctor_education);
        mEmail = findViewById(R.id.edit_doctor_email);
        mAge = findViewById(R.id.edit_doctor_age);
        mContact = findViewById(R.id.edit_doctor_contact);
        mAddress = findViewById(R.id.edit_doctor_address);
    ...
    private void alertDialog(String text, final String detail){
        ...
        TextView textView = view.findViewById(R.id.update_textView);

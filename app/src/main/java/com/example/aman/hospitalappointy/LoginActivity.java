...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmail = findViewById(R.id.login_email_layout);
        mPassword = findViewById(R.id.login_password_layout);
        mLogin = findViewById(R.id.login_button);
        mForgot = findViewById(R.id.login_forgot_button);
        mRegister = findViewById(R.id.login_register_button);
